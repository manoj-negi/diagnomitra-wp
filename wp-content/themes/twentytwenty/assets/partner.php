...
<body>
    ...
    <div id="root">
        ...
        <section class="breadcrumbs section-padding background6 align-items-center"
            style="background-image:url(<?php bloginfo('template_url'); ?>/static.joonsite.com/storage/21443/media/2404251316312355.png);background-repeat:no-repeat;background-size:cover;width:100%;display:flex;background-position:center;height:300px;"
            id="breadcrumb_1">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="breadcrumbs_style text-start text-lg-center">
                            <div class="fontStyle3 mb-2 theme-title">Partners</div>
                            <div class="fontStyle8"><span class="breadcrumb-content fontStyle8"><a
                                        href="/">Home</a></span><span class="breadcrumb-content fontStyle8"><a
                                        href="partner">Partner</a></span></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section-padding " id="content_2">
            <div class="container">
                <div class="px-3 content-padding text-start text-lg-start ">
                    <div class="fontStyle3 mg-1 theme-title"><span class="jwset"><span
                                style="color:var(--color1);">Our</span> <span style="color:var(--color3);">Partners
                                :-</span></span></div>
                    <div class="content_data fontStyle7 mg-2">
                        <p>Right now we are official partner of :-</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="about-row d-flex flex-wrap flex-row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <figure class="media-fit"><a href="javascript:void(0);"><img class=""
                                    src="<?php bloginfo('template_url'); ?>/static.joonsite.com/storage/21443/media/2404241324254432.webp"
                                    alt=""></a></figure>
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-12 flex-grow-1  content-padding px-3">
                        <div class="text-start text-lg-start">
                            <div class="about-title fontStyle3 mb-3 theme-title">CNC Pathlab</div>
                            <div class="para fontStyle7 content_data">CNC Pathlab based in&nbsp;capital of India, the
                                diagnostic centre offers an impeccable patient care provided by staff&nbsp;and also
                                the&nbsp;ambient environmental facilities. These benchmarks mark
                                them&nbsp;joined&nbsp;of&nbsp;the foremost&nbsp;reputed diagnostic centres&nbsp;within
                                the&nbsp;national capital.</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="padding-4 about-page about1 position-relative " id="about_4">
            <div class="container">
                <div class="about-row d-flex flex-wrap flex-row-reverse align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <figure class="media-fit"><a href="javascript:void(0);"><img class=""
                                    src="<?php bloginfo('template_url'); ?>/static.joonsite.com/storage/21443/media/2404301207029349.jpg"
                                    alt=""></a></figure>
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-12 flex-grow-1  content-padding px-3">
                        <div class="text-start text-lg-start">
                            <div class="about-title fontStyle3 mb-3 theme-title">MOL Q Laboratory</div>
                            <div class="para fontStyle7 content_data">MolQ diagnostic lab provides quality diagnostic
                                services, within a given particular time frame and that too, in a cost effective manner.
                                Equipped with highly skilled phlebotomists, who take blood samples in a sanitary way,
                                MolQ is worth opting for.</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="padding-4 about-page about1 position-relative background4" id="about_5">
            <div class="container">
                <div class="about-row d-flex flex-wrap flex-row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <figure class="media-fit"><a href="javascript:void(0);"><img class=""
                                    src="<?php bloginfo('template_url'); ?>/static.joonsite.com/storage/21443/media/2404241324284548.webp"
                                    alt=""></a></figure>
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-12 flex-grow-1  content-padding px-3">
                        <div class="text-start text-lg-start">
                            <div class="about-title fontStyle3 mb-3 theme-title">Thyrocare</div>
                            <div class="para fontStyle7 content_data">Thyrocare Medical Test Labs, a beacon of
                                innovation and reliability in the realm of diagnostic healthcare, stands as a testament
                                to pioneering excellence in the field.</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="padding-4 about-page about1 position-relative " id="about_6">
            <div class="container">
                <div class="about-row d-flex flex-wrap flex-row-reverse align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <figure class="media-fit"><a href="javascript:void(0);"><img class=""
                                    src="<?php bloginfo('template_url'); ?>/static.joonsite.com/storage/21443/media/2404241324277316.webp"
                                    alt=""></a></figure>
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-12 flex-grow-1  content-padding px-3">
                        <div class="text-start text-lg-start">
                            <div class="about-title fontStyle3 mb-3 theme-title">nirAmaya PathLabs</div>
                            <div class="para fontStyle7 content_data">Niramaya Healthcare is an elite Pathology and
                                Wellness service provider with presence in the National Capital Region of Delhi. It was
                                started by a group of professionals with the motto of &quot;Affordable, Accurate and
                                Accredited pathology at your footstep&quot;.&nbsp;</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="padding-4 about-page about1 position-relative background4" id="about_7">
            <div class="container">
                <div class="about-row d-flex flex-wrap flex-row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <figure class="media-fit"><a href="javascript:void(0);"><img class=""
                                    src="<?php bloginfo('template_url'); ?>/static.joonsite.com/storage/21443/media/2404241324247406.webp"
                                    alt=""></a></figure>
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-12 flex-grow-1  content-padding px-3">
                        <div class="text-start text-lg-start">
                            <div class="about-title fontStyle3 mb-3 theme-title">Agilus Diagnostics</div>
                            <div class="para fontStyle7 content_data">Agilus Diagnostics has the largest network of NABL
                                accredited labs &nbsp;as of March 31, 2023 (Source: CRISIL Report). We have an extensive
                                diagnostics network in India spread across 25 states and five union territories covering
                                over 1,000 towns and cities and over 532 districts, as of March 31, 2023.</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="padding-4 about-page about1 position-relative " id="about_8">
            <div class="container">
                <div class="about-row d-flex flex-wrap flex-row-reverse align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <figure class="media-fit"><a href="javascript:void(0);"><img class=""
                                    src="<?php bloginfo('template_url'); ?>/static.joonsite.com/storage/21443/media/2404301207221912.jpg"
                                    alt=""></a></figure>
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-12 flex-grow-1  content-padding px-3">
                        <div class="text-start text-lg-start">
                            <div class="about-title fontStyle3 mb-3 theme-title">Orange Health</div>
                            <div class="para fontStyle7 content_data">
                                <p>Our view on healthcare is that, like much else, it should reach our homes &ndash;
                                    conveniently and affordably.We believe being connected to&nbsp;your
                                    doctor&nbsp;matters. A personal connect and context in healthcare cannot be
                                    replaced.Effective medicine will be when online and offline worlds combine.&nbsp;
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="padding-4 about-page about1 position-relative background4" id="about_9">
            <div class="container">
                <div class="about-row d-flex flex-wrap flex-row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <figure class="media-fit"><a href="javascript:void(0);"><img class=""
                                    src="<?php bloginfo('template_url'); ?>/static.joonsite.com/storage/21443/media/2404241324268978.webp"
                                    alt=""></a></figure>
                    </div>
                    <div class="col-lg-9 col-md-8 col-sm-12 flex-grow-1  content-padding px-3">
                        <div class="text-start text-lg-start">
                            <div class="about-title fontStyle3 mb-3 theme-title">Healthians</div>
                            <div class="para fontStyle7 content_data">At Healthians, we are on a mission to redefine
                                healthcare by placing the power of comprehensive wellness firmly in your hands. We
                                understand that your health is not just a matter of moments, but a lifelong journey
                                deserving of attention, care, and empowerment.</div>
                        </div>
                    </div>
                </div>
            </div>
